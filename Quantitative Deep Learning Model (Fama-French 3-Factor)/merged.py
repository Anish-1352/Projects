...
import numpy as np
def load_data():
    factor_df = pd.read_csv("C:/Users/anish/OneDrive/Desktop/Columbia MAFN/Intro to Math Finance/Project/3 Fama Factors.csv", skiprows=0)
    ...
    msft_df = pd.read_csv("C:/Users/anish/OneDrive/Desktop/Columbia MAFN/Intro to Math Finance/Project/MSFT data for FF.csv", skiprows=0)
