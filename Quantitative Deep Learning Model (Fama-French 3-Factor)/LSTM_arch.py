...
def ARch():
    ...
    model.add(LSTM(units=125, return_sequences= True, input_shape=(X_train.shape[1], X_train.shape[2])))
    ...
    earlystopping_val= EarlyStopping(monitor ="val_loss", patience =5, restore_best_weights = True)
